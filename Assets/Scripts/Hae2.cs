...
public class Hae2 : MonoBehaviour {
    // ヒットポイント
    public int hp = 3;
    ...
    IEnumerator Start()
    {
        ...
        haecolor = sprender.material.color;
    ...
    {
        if(Mathf.Abs(transform.position.y) >= 0.8)
        {
            sprender.material.color = new Color(0, 0, 0, 0.0f);
        }else
        {
            sprender.material.color = haecolor;
        }
